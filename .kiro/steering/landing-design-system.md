...
- NO border-radius anywhere — all corners are sharp (remove all `rounded-*` classes)
...
## Typography
- Headlines: `font-medium` or `font-light` (NOT font-black/font-bold) — clean, not heavy
- Section labels: `text-[10px] font-mono tracking-widest uppercase text-white/30`
...
- Grids: Use `gap-px border border-white/10 bg-white/10 p-px` for Neon-style grid
