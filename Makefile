# =============================================================================
# Makefile — Pixielity Frontend Monorepo
# =============================================================================
#
...
help:
	@echo "$(BLUE)Pixielity Frontend Monorepo — Available Commands$(NC)"
	@echo ""
...
## fix-deps: Fix all @abdokouta/* deps to use workspace:*
fix-deps:
